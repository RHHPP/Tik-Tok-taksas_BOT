import json, requests, os, shlex, asyncio, uuid, shutil 
 ...
 START_BUTTONS=[ 
     [ 
         InlineKeyboardButton('السورس', url='https://github.com/TEKASA1_BOT'), 
         InlineKeyboardButton('قناة البوتات', url='https://t.me/TEKASA1_BOT'), 
     ],] 
 ...
 @TEKSAS1_BOT.on_message(filters.command('start') & filters.private) 
 async def _start(bot, update): 
   await update.reply_text(f" مرحبا أنا بوت تيكساس وضيفتي تحميل من التيكتوك يمكنك تحميل الفيديوهات او المقاطع الصوتية من هنا فقط ارسل رابط المقطع هنا", True, reply_markup=InlineKeyboardMarkup(START_BUTTONS)) 
  
 # Downloader for tiktok 
 @TEKSAS1_BOT.on_message(filters.regex(pattern='.*http.*') & filters.private) 
